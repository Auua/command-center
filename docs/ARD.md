...
ADRs 019–038 are tracked in `docs/adr/REVIEW-QUEUE.md`; 020, 021, 022, 023, 027, 029, 033, 036, 037, and 038 are **accepted**, 034 is **rejected**, and 030/031 are **parked** (product-owner walkthrough, 2026-07-16); the rest are **proposed and pending review** — see the queue for the review
