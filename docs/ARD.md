...
ADRs 019–038 are tracked in `docs/adr/REVIEW-QUEUE.md`; 023, 029, and 038 are **accepted** (product-owner walkthrough, 2026-07-16), the rest **proposed and pending review** — see the queue for the review
