...
ADRs 019–038 are tracked in `docs/adr/REVIEW-QUEUE.md`; 020, 021, 022, 023, 024, 027, 028, 029, 033, 036, 037, and 038 are **accepted**, 025 and 034 are **rejected**, and 030/031 are **parked** (product-owner walkthroughs, 2026-07-16/-17); the rest are **proposed and pending review** — see the queue for the review
state of each. Several ARD edits are **owed once the relevant ADRs are approved**: R5 (content sourcing) is closed by ADR-032 — licensed bulk datasets for
